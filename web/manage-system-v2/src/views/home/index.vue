  ...
  <div class="container">
      ...
      <div class="header-part" v-show="whetherShowHeader">
        ...
        <bread-crumbs class="bread-crumb">
          <template v-for="item in this.$route.matched">
            <bread-crumb-item :to="item.path" :key="item.name">{{item.meta.title}}</bread-crumb-item>
          </template>
        </bread-crumbs>
        <!-- 搜索框 -->
    ...
    <div class="main-part">
      ...
      <transition name="menu-fade">
        <menu-list class="menu-list" v-show="whetherShowMenuR" type="transition" appear></menu-list>
      </transition>
    </div>
